    ...
    <form id="form" action="includes/signup.inc.php" name="form" method="post">
        <div class="form_content">
            ...
            <div>
                ...
                <input type="text" name="email" id="email" placeholder="E-mail" required="" class="envelope_input"><br>
            </div>
        ...
        <div>
            ...
            <div>
                ...
                <select oninput="city_check()" id="city" name="city" class="building_select">
