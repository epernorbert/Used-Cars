...
<div style="border-top: 2px solid grey; margin: 0 0 0 10%; padding: 0; float: left; font-size: 20px;">
    <table>
        <tr>
...
<div id="form" style="font-size: 20px; display: inline-block; margin: 0 0 0 3%;"></div>
    ...
    if(!isset($GLOBALS['car_id'])){
        ...
        echo '<div style="clear: both;">
              ...
              <div style="clear: both; float: left; margin: 0 2% 0 10%; width: 35%; border-top: 2px solid grey; font-size: 20px;">
                    <table class="car_data" >
                        ...
                        <tr>
                        <td colspan="2" >
                            <div style="border-bottom: 2px solid grey; margin-top: 8px;" >
                        ...
                        <tr>
                            <td><button style="height: 28px; font-size: 15px; width: 100px; cursor: pointer; " onclick="cars()">Módosít</button></td>
                            <td><button  onclick="confirm_delete()" style="background-color: red; cursor: pointer; font-size: 15px; width: 130px; height: 28px; ">Hírdetés törlése</button></td>
                        </tr>
                    </table>
               </div>
...
<?php
    ...
    if(isset($GLOBALS['car_id'])){
        ...
        while($row_img = mysqli_fetch_assoc($result_img)) {
            echo '<div style=" display: inline-block; margin: 0;"><img class="image" src=uploads/' . $row_img['image_name'] . ' style="margin-right:10px; margin-bottom: 7px; display: block; object-fit: cover;/* nagyítás, egyforma képek */ width: 180px; height: 110px;"></div>';
        }
        echo '</div>';
